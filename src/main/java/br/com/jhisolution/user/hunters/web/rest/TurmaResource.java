...
/**
 * REST controller for managing {@link br.com.jhisolution.user.hunters.domain.Turma}.
 */
@RestController
@RequestMapping("/api")
public class TurmaResource {
    ...
    private static final String ENTITY_NAME = "matriculaTurma";
    ...
    public ResponseEntity<Turma> updateTurma(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody Turma turma)
        ...
        Turma result = turmaService.update(turma);
        return ResponseEntity
            .ok()
