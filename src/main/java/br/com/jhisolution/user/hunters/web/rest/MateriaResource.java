...
/**
 * REST controller for managing {@link br.com.jhisolution.user.hunters.domain.Materia}.
 */
@RestController
@RequestMapping("/api")
public class MateriaResource {
    ...
    private static final String ENTITY_NAME = "matriculaMateria";
     ...
     */
    @GetMapping("/materias")
    public ResponseEntity<List<Materia>> getAllMaterias(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
