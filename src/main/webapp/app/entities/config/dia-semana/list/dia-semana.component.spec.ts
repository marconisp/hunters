...
describe('DiaSemana Management Component', () => {
  let comp: DiaSemanaComponent;
  let fixture: ComponentFixture<DiaSemanaComponent>;
  let service: DiaSemanaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dia-semana', component: DiaSemanaComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DiaSemanaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.diaSemanas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
