...
export class EstadoCivilComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.estadoCivilService
      ...
      .subscribe({
        next: (res: HttpResponse<IEstadoCivil[]>) => {
  ...
  trackId(_index: number, item: IEstadoCivil): number {
    return item.id!;
  }

  delete(estadoCivil: IEstadoCivil): void {
    const modalRef = this.modalService.open(EstadoCivilDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.estadoCivil = estadoCivil;
  ...
  protected onSuccess(data: IEstadoCivil[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
