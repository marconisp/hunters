...
describe('EstadoCivil Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'estado-civil', component: EstadoCivilComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.estadoCivils?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
