...
describe('Religiao Management Component', () => {
  let comp: ReligiaoComponent;
  let fixture: ComponentFixture<ReligiaoComponent>;
  let service: ReligiaoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'religiao', component: ReligiaoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ReligiaoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.religiaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
