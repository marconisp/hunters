...
export class TipoPessoaComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tipoPessoaService
      ...
      .subscribe({
        next: (res: HttpResponse<ITipoPessoa[]>) => {
  ...
  trackId(_index: number, item: ITipoPessoa): number {
    return item.id!;
  }

  delete(tipoPessoa: ITipoPessoa): void {
    const modalRef = this.modalService.open(TipoPessoaDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.tipoPessoa = tipoPessoa;
  ...
  protected onSuccess(data: ITipoPessoa[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
