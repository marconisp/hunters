...
describe('TipoPessoa Management Component', () => {
  let comp: TipoPessoaComponent;
  let fixture: ComponentFixture<TipoPessoaComponent>;
  let service: TipoPessoaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tipo-pessoa', component: TipoPessoaComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TipoPessoaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tipoPessoas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
