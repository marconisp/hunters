...
describe('Raca Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'raca', component: RacaComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.racas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
