...
export class RacaComponent implements OnInit {
  ...
  trackId(_index: number, item: IRaca): number {
    return item.id!;
  }

  delete(raca: IRaca): void {
    const modalRef = this.modalService.open(RacaDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IRaca[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
