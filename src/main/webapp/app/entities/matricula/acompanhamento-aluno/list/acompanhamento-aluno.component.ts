...
export class AcompanhamentoAlunoComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.acompanhamentoAlunoService
      ...
      .subscribe({
        next: (res: HttpResponse<IAcompanhamentoAluno[]>) => {
  ...
  trackId(_index: number, item: IAcompanhamentoAluno): number {
    return item.id!;
  }

  delete(acompanhamentoAluno: IAcompanhamentoAluno): void {
    const modalRef = this.modalService.open(AcompanhamentoAlunoDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.acompanhamentoAluno = acompanhamentoAluno;
  ...
  protected onSuccess(data: IAcompanhamentoAluno[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
