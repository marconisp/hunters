...
describe('Matricula routing resolve service', () => {
  ...
  let resultMatricula: IMatricula | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IMatricula if id is not provided', () => {
      // GIVEN
      ...
      expect(resultMatricula).toEqual(new Matricula());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Matricula })));
      mockActivatedRouteSnapshot.params = { id: 123 };
