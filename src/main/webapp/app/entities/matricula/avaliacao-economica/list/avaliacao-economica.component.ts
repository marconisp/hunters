...
export class AvaliacaoEconomicaComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.avaliacaoEconomicaService
      ...
      .subscribe({
        next: (res: HttpResponse<IAvaliacaoEconomica[]>) => {
  ...
  trackId(_index: number, item: IAvaliacaoEconomica): number {
    return item.id!;
  }

  delete(avaliacaoEconomica: IAvaliacaoEconomica): void {
    const modalRef = this.modalService.open(AvaliacaoEconomicaDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.avaliacaoEconomica = avaliacaoEconomica;
  ...
  protected onSuccess(data: IAvaliacaoEconomica[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
