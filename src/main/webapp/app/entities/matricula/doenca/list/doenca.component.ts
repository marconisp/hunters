...
export class DoencaComponent implements OnInit {
  ...
  trackId(_index: number, item: IDoenca): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IDoenca[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
