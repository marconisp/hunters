...
export class AvisoComponent implements OnInit {
  ...
  trackId(_index: number, item: IAviso): number {
    return item.id!;
  }

  delete(aviso: IAviso): void {
    const modalRef = this.modalService.open(AvisoDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IAviso[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
