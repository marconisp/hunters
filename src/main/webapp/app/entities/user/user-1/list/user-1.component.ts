...
export class User1Component implements OnInit {
  ...
  trackId(_index: number, item: IUser1): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IUser1[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
