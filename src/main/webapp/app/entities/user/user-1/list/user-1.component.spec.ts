...
describe('User1 Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'user-1', component: User1Component }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.user1s?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
