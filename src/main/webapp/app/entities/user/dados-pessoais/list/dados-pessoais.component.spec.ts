...
describe('DadosPessoais Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dados-pessoais', component: DadosPessoaisComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dadosPessoais?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
