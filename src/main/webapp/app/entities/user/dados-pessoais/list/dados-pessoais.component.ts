...
export class DadosPessoaisComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.dadosPessoaisService
      ...
      .subscribe({
        next: (res: HttpResponse<IDadosPessoais[]>) => {
  ...
  trackId(_index: number, item: IDadosPessoais): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IDadosPessoais[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
