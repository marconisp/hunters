...
export class ColaboradorComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.colaboradorService
      ...
      .subscribe({
        next: (res: HttpResponse<IColaborador[]>) => {
  ...
  trackId(_index: number, item: IColaborador): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IColaborador[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
