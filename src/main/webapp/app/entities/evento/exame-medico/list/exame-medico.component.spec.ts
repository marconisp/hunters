...
describe('ExameMedico Management Component', () => {
  let comp: ExameMedicoComponent;
  let fixture: ComponentFixture<ExameMedicoComponent>;
  let service: ExameMedicoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'exame-medico', component: ExameMedicoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ExameMedicoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.exameMedicos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
