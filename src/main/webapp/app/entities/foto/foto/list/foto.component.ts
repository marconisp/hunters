...
export class FotoComponent implements OnInit {
  ...
  trackId(_index: number, item: IFoto): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IFoto[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
