...
describe('Receber Management Component', () => {
  let comp: ReceberComponent;
  let fixture: ComponentFixture<ReceberComponent>;
  let service: ReceberService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'receber', component: ReceberComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ReceberComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.recebers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
