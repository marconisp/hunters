...
describe('TipoContratacao Management Component', () => {
  let comp: TipoContratacaoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'tipo-contratacao', component: TipoContratacaoComponent }]),
      ...
      .overrideTemplate(TipoContratacaoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tipoContratacaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
