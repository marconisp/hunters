...
describe('SubGrupoProduto Management Component', () => {
  let comp: SubGrupoProdutoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'sub-grupo-produto', component: SubGrupoProdutoComponent }]),
      ...
      .overrideTemplate(SubGrupoProdutoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.subGrupoProdutos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
