...
describe('GrupoProduto Management Component', () => {
  let comp: GrupoProdutoComponent;
  let fixture: ComponentFixture<GrupoProdutoComponent>;
  let service: GrupoProdutoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'grupo-produto', component: GrupoProdutoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(GrupoProdutoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.grupoProdutos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
