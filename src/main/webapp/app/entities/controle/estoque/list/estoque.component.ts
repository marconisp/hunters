...
export class EstoqueComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.estoqueService
      ...
      .subscribe({
        next: (res: HttpResponse<IEstoque[]>) => {
  ...
  trackId(_index: number, item: IEstoque): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IEstoque[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
