...
describe('Estoque routing resolve service', () => {
  ...
  let routingResolveService: EstoqueRoutingResolveService;
  let service: EstoqueService;
  let resultEstoque: IEstoque | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(EstoqueRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IEstoque if id is not provided', () => {
      // GIVEN
      ...
      expect(resultEstoque).toEqual(new Estoque());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Estoque })));
      mockActivatedRouteSnapshot.params = { id: 123 };
