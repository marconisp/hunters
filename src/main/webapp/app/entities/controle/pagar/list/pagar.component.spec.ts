...
describe('Pagar Management Component', () => {
  let comp: PagarComponent;
  let fixture: ComponentFixture<PagarComponent>;
  let service: PagarService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pagar', component: PagarComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PagarComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pagars?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
