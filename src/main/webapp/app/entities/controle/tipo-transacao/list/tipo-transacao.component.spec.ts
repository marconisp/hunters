...
describe('TipoTransacao Management Component', () => {
  let comp: TipoTransacaoComponent;
  let fixture: ComponentFixture<TipoTransacaoComponent>;
  let service: TipoTransacaoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tipo-transacao', component: TipoTransacaoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TipoTransacaoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tipoTransacaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
