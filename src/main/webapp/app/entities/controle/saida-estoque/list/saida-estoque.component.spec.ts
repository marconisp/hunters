...
describe('SaidaEstoque Management Component', () => {
  let comp: SaidaEstoqueComponent;
  let fixture: ComponentFixture<SaidaEstoqueComponent>;
  let service: SaidaEstoqueService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'saida-estoque', component: SaidaEstoqueComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SaidaEstoqueComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.saidaEstoques?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
