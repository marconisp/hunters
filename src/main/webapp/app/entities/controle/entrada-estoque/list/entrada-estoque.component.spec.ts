...
describe('EntradaEstoque Management Component', () => {
  let comp: EntradaEstoqueComponent;
  let fixture: ComponentFixture<EntradaEstoqueComponent>;
  let service: EntradaEstoqueService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'entrada-estoque', component: EntradaEstoqueComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(EntradaEstoqueComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.entradaEstoques?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
